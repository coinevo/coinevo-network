...
extern "C"
{
  ...
  /// packet writer to send packets to coinevonet internals
  struct llarp_vpn_writer_pipe;
  /// packet reader to recv packets from coinevonet internals
  ...
  struct llarp_vpn_io
  {
    ...
    /// user data
    void *user;
    /// hook set by user called by coinevonet core when coinevonet is done with the
    /// vpn io
    void (*closed)(struct llarp_vpn_io *);
    /// hook set by user called from coinevonet core after attempting to inject
  ...
  /// info about the network interface that we give to coinevonet core
  ...
  /// get the packet pipe for writing IP packets to coinevonet internals
  ...
  /// get the packet pipe for reading IP packets from coinevonet internals
  /// returns nullptr if llarp_vpn_io is nullptr or not initialized
  struct llarp_vpn_pkt_reader *
  llarp_vpn_io_packet_reader(struct llarp_vpn_io *io);

  /// blocking read on packet reader from coinevonet internals
  ...
  /// blocking write on packet writer to coinevonet internals
