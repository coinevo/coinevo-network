...
#define MyAppName "Coinevonet"
#define MyAppVersion "0.6.1"
#define MyAppPublisher "Coinevo Project"
#define MyAppURL "https://coinevo.tech"
#define MyAppExeName "coinevonetui.exe"
...
OutputBaseFilename=coinevonet-win32
Compression=lzma2/ultra64
SolidCompression=yes
VersionInfoVersion=0.6.1
VersionInfoCompany=Coinevo Project
VersionInfoDescription=Coinevonet for Microsoft® Windows® NT™
#ifndef RELEASE
...
#endif
VersionInfoProductName=Coinevonet
VersionInfoProductVersion=0.6.1
InternalCompressLevel=ultra64
MinVersion=0,5.0
ArchitecturesInstallIn64BitMode=x64
VersionInfoCopyright=Copyright ©2018-2020 Coinevo Project
...
#ifdef SINGLE_ARCH
Source: "{#DevPath}build\coinevonet.exe"; DestDir: "{app}"; Flags: ignoreversion
; don't ship it, we don't have a public api yet!
;Source: "{#DevPath}build\libcoinevonet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "dbghelp64.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}build\coinevonet.exe"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
;Source: "{#DevPath}build\libcoinevonet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
Source: "dbghelp32.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsWin64
Source: "{#DevPath}build64\coinevonet.exe"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
;Source: "{#DevPath}build64\libcoinevonet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
Source: "dbghelp64.dll"; DestDir: "{app}"; DestName: "dbghelp.dll"; Flags: ignoreversion; Check: IsWin64
#endif
; UI has landed!
#ifndef RELEASE
Source: "{#DevPath}ui-win32\bin\debug\coinevonetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\coinevonetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\coinevonetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}ui-win32\bin\release\coinevonetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\coinevonetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\coinevonetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#endif
; eh, might as well ship the 32-bit port of everything else
Source: "{#DevPath}build\testAll.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}build\coinevonetctl.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion
Source: "coinevonet-bootstrap.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Type: filesandordirs; Name: "{userappdata}\.coinevonet"
...
Filename: "{app}\coinevonet-bootstrap.exe"; Parameters:"-L https://seed.coinevo.tech/coinevonet.signed --cacert rootcerts.pem -o ""{userappdata}\.coinevonet\bootstrap.signed"""; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated; Description: "bootstrap dht"; StatusMsg: "Downloading initial RC..."
